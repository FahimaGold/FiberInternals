...
React Fiber is the new reconcilier that was created from scratch starting from `React 16` in order to overcome the shortcomings of using the javascript call stack ,you find all the details about React fibers associated with this experiment in [this article](https://df-mokhtari.medium.com/part-2-react-reconciliation-a-deep-dive-react-fibers-28fba20e3334). React fiber came into place for these four reasons:
